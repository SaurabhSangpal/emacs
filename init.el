...
(ensure-package-installed 'magit 'csharp-mode 'flycheck 'helm 'dash 'f 'use-package 'async 'popup 'popwin 'company 'yasnippet 'omnisharp 'projectile 'smartparens 'powerline 'indent-guide 'ample-theme)
...
;;			 '(font . "InputMono 12"))
(set-face-attribute 'default nil :family "InputMono" :height 115 :weight 'regular :width 'condensed)
